...
const team = [
  {
    ...
    bio: 'Ex-Amazon. 8+ years in finance and analytics. Former finance lead at Amazon India, managed P&L for a $200M+ business unit. Previously at American Express and TriNet. Built SK Capital to bring clean reporting, forecasting, and decision-ready finance systems to growing businesses.',
    education: 'MBA, Finance',
    linkedin: 'https://in.linkedin.com/in/sneshkakkar',
  ...
  },
  {
    ...
    initials: 'MD',
    role: 'Co-founder, SK Capital',
    bio: 'Finance and reporting specialist with 7+ years of experience. Former senior analyst at Deloitte and Genpact. Expert in MIS design, financial reporting automation, and startup financial operations. Passionate about making numbers actionable for founders.',
    education: 'CA, CPA',
    linkedin: 'https://linkedin.com/in/megha-dalmia',
